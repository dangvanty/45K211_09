...
// Create Order
export const createOrder = ({shippingInfo,orderItems,itemsPrice,taxPrice,shippingPrice,totalPrice}) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.post("/api/v1/order/new", {shippingInfo,orderItems,itemsPrice,taxPrice,shippingPrice,totalPrice}, config);
